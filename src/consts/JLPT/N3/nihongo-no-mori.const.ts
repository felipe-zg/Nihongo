export const NIHONGO_NO_MORI_JLPT_N3: JLPTReview[] = [
  ...
  },
  {
    ...
    kana: "たたむ",
    english: "To fold",
    explanation: "Refers to the action of folding something, such as clothes or paper.",
    example: "シャツを{畳んだ}。\nI folded the shirt."
  },
  {
    kanji: "結ぶ",
  ...
  },
  {
    kanji: "囲む",
    kana: "かこむ",
    english: "To surround・To enclose",
    explanation: "Refers to the action of surrounding or enclosing something.",
    example: "木々が{囲んでいる}。\nThe trees are surrounding it."
  },
  {
    kanji: "運休",
    kana: "うんきゅう［する］",
    english: "Suspension of service・To suspend service",
    explanation: "Refers to the temporary halt of transportation services like trains or buses. 運転を休むこと。",
    example: "乗る予定だった電車が{運休}している。\nThe train I was supposed to take is suspended."
  },
  {
    kanji: "遅刻",
    kana: "ちこく［する］",
    english: "Tardiness・To be late",
    explanation: "Refers to arriving later than the scheduled time for an appointment or event.\nUsed with people, not things. 人が遅刻する。",
  ...
  },
  {
    ...
    explanation: "Refers to the action of hitting or striking something.",
    example: "部屋に人がいるか確認するため、ドアを{叩いた}。\nI knocked on the door to check if there was anyone in the room."
  },
  {
    kanji: "眺める",
    kana: "ながめる",
    english: "To gaze・To stare・ To look at",
    explanation: "Refers to the action of looking at something for a long time, often with admiration.",
    example: "景色を{眺めた}。\nI gazed at the scenery."
  },
  {
    kanji: "なぞる",
    kana: "なぞる",
    english: "To trace・To follow",
    explanation: "Refers to the action of following a line or shape with a finger or pen.",
  ...
  },
  {
    kanji: "取り消す",
    kana: "とりけす",
    english: "Cancellation・To cancel",
    explanation: "Refers to the act of canceling something that was previously planned or arranged.",
    example: "予定が変わったので、美容院の予約を{取り消さなければならない}。\nI have to cancel my hair appointment."
  },
  {
    kanji: "折れる",
    kana: "おれる",
  ...
  },
  {
    ...
    explanation: "Refers to the action of cooking food using dry heat, such as baking or grilling.",
    example: "美味しいパンを{焼いた}。\nI baked delicious bread."
  },
  {
    kanji: "燃える",
    kana: "もえる",
  ...
  },
  {
    kanji: "消極的な",
    kana: "しょうきょくてき［な］",
    english: "Negative・Passive",
    explanation: "Refers to a passive or negative attitude towards situations or tasks.",
    example: "私も彼も{消極的な}ので、あまり一緒に話をしたことがない。\nBoth he and I are passive, so we haven't talked much together."
  },
  {
    kanji: "比較的な",
    kana: "ひかくてき［な］",
    english: "Comparative・Relatively",
    explanation: "Refers to something that is considered in relation to something else, often indicating a relative degree or extent.",
    example: "今日は{比較的}暑い。\nToday is relatively hot. (Compared to other days)"
  },
  {
    kanji: "自動的な",
    kana: "じどうてき［な］",
    english: "Automatic・Automatically",
    explanation: "Refers to something that operates or happens without human intervention.",
    example: "このドアは{自動的に}開く。\nThis door opens automatically."
  },
  {
    kanji: "ぴったり",
    kana: "ぴったり［する］",
    english: "Perfectly・Exactly・To fit perfectly",
    explanation: "Refers to something that fits perfectly or is exactly right.",
    example: "体に{ぴったり}合う服を買う。\nI buy clothes that fit my body perfectly."
  },
  {
    kanji: "ばったり",
    kana: "ばったり［する］",
    english: "Suddenly・By chance・To meet by chance",
    explanation: "Refers to something happening suddenly or unexpectedly, often used when meeting someone by chance.",
    example: "駅前で{ばったり}ゆか先生に会ったんだよ。\nI met Yuka-sensei by chance (suddenly; without planning) in front of the station."
  },
  {
    kanji: "さっぱり",
    kana: "さっぱり 〜 ない",
  ...
  },
  {
    ...
    example: "昨夜は疲れていたので、{ぐっすり}眠れた。\nI was tired last night, so I slept soundly."
  },
  {
    kanji: "たっぷり",
    kana: "たっぷり［する］",
    ...
    example: "このケーキはクリームが{たっぷり}入っている。\nThis cake has plenty of cream."
  },
  {
    kanji: "ぎっしり",
    kana: "ぎっしり［する］",
  ...
  },
  {
    ...
    explanation: "Refers to the act of being delayed or causing a delay, often used in the context of transportation or schedules. (来る時間に来ないこと）",
    example: "電車が１０分{遅延しました}。\nThe train was delayed by 10 minutes."
  },
  {
    kanji: "延長",
    kana: "えんちょう［する］",
    english: "Extension・To extend",
    explanation: "Refers to the act of extending the duration or length of something, such as a deadline or a stay. Can be used for things as well as time periods.",
    example: "宿題の締め切りが一週間{延長された}。\nThe homework deadline was extended by one week."
  },
  {
    kanji: "早退",
    kana: "そうたい［する］",
  ...
  },
  {
    ...
    explanation: "Refers to the costs associated with traveling, such as bus or train fares.",
    example: "会社は毎月{交通費}を支給する。\nThe company provides transportation expenses every month."
  },
  {
    kanji: "支給",
    kana: "しきゅう［する］",
  ...
  },
  {
    ...
    example: "このセールは今日だけに{限られています}。\nThis sale is limited to today only."
  },
  {
    kanji: "收入",
    kana: "しゅうにゅう",
    ...
    example: "彼の月{收入}は非常に高い。\nHis monthly income is very high."
  },
  {
    kanji: "流行",
    kana: "りゅうこう［する］",
  ...
  },
  {
    ...
    explanation: "The physical structure of a person or animal, including the bones, flesh, and organs.",
    example: "毎日運動して、{身体}を健康に保つ。\nExercise every day to keep the body healthy.",
    fromBook: true,
  },
  {
    kanji: "見物",
  ...
  },
  {
    ...
    explanation: "To make a brief visit to a place, often on the way to another destination.",
    example: "学校へ行く途中で、コンビニに{寄る}。\nI'll stop by the convenience store on the way to school.",
    fromBook: true,
  },
  {
    kanji: "構う",
    kana: "かまう",
    english: "To mind・to care about",
    explanation: "To be concerned or bothered by something or someone.",
    example: "彼の意見にあまり{構わない}ようにしている。\nI try not to care too much about his opinion.",
    fromBook: true,
  },
  {
    kanji: "渡る",
    ...
    explanation: "To move from one side to another, often over a bridge, road, or body of water.",
    example: "信号が青になったら、道路を{渡って}ください。\nPlease cross the road when the signal turns green.",
    fromBook: true,
  },
  {
    kanji: "価値",
    kana: "かち",
    english: "Value・worth",
    explanation: "The importance, usefulness, or worth of something.",
    example: "この絵は非常に高い{価値}がある。\nThis painting has very high value.",
    fromBook: true,
  },
  {
    kanji: "壊す",
  ...
  },
  {
    ...
    explanation: "The way a person behaves or conducts themselves in a particular situation.",
    example: "彼の{態度}はいつも冷静で理性的だ。\nHis attitude is always calm and rational.",
    fromBook: true,
  },
  {
    kanji: "謝罪",
    kana: "しゃざい［する］",
    english: "Apology・to apologize",
    explanation: "The act of expressing regret or remorse for a mistake or wrongdoing.",
    example: "彼は遅刻したことを深く{謝罪}した。\nHe deeply apologized for being late.",
    fromBook: true,
  },
  {
    kanji: "失礼",
    ...
    explanation: "Behavior or actions that are disrespectful or offensive to others.",
    example: "{失礼な}態度をとったので、謝罪した。\nI apologized because I behaved rudely.",
  },
  {
    kanji: "短気",
    kana: "たんき［な］",
  ...
  },
  {
    ...
    explanation: "A sheet of paper used for writing or printing information, often for official purposes.",
    example: "申請{用紙}に必要事項を記入してください。\nPlease fill in the required information on the application form.",
  },
  {
    kanji: "珍しい",
    kana: "めずらしい",
    english: "Rare・unusual",
    explanation: "Something that is uncommon or not frequently encountered.",
    example: "この動物は非常に{珍しい}種類です。\nThis animal is a very rare species.",
  },
  {
    kanji: "応用",
    kana: "おうよう［する］",
    english: "Application・to apply",
    explanation: "The act of putting something into practical use or adapting it for a specific purpose.",
    example: "学んだ知識を実際の問題に{応用}する。\nApply the knowledge learned to real-world problems.",
  },
  {
    kanji: "ちっとも 〜 ない",
    kana: "ちっとも 〜 ない",
  ...
  },
  {
    ...
    explanation: "A prescribed guideline or regulation that governs behavior or actions.",
    sameMeaning: "ルールっていう意味だ・規則っていう意味だ",
    example: "学校の{決まり}を守ることは大切だ。\nIt is important to follow the school rules.",
  },
  {
    kanji: "変更",
    kana: "へんこう［する］",
    english: "Change・to change",
    explanation: "The act of making something different from its original state.",
    example: "予定を{変更}して、明日にしました。\nI changed the schedule to tomorrow.",
  },
  {
    kanji: "非常に",
    kana: "ひじょうに",
  ...
  },
  {
    kanji: "郵送",
    kana: "ゆうそう［する］",
    english: "Mailing・to mail",
    explanation: "The act of sending something through the postal service.\n紙のものを送ること",
    example: "今週中にパンフレットを{郵送}いたします。\nI will mail the pamphlet within this week.",
  },
  {
    kanji: "送信",
    kana: "そうしん［する］",
    english: "Transmission・to transmit",
    explanation: "The act of sending information electronically, such as via email or messaging.",
    example: "メールを{送信}した後、確認のメッセージが届いた。\nAfter sending the email, I received a confirmation message.",
  },
  {
    kanji: "捕まえる",
    kana: "つかまえる",
    english: "To catch・to capture",
    explanation: "To seize or take hold of something or someone.",
  ...
  },
  {
    kanji: "生える",
    kana: "はえる",
    english: "To grow・to sprout",
    explanation: "To develop or emerge, often referring to plants, hair, or teeth.",
    example: "春になると、庭に新しい草が{生えて}くる。\nIn spring, new grass grows in the garden.",
    important: true,
  },
  {
    kanji: "超える",
    ...
    explanation: "To go beyond a certain limit or threshold.",
    example: "今年の売上は1億円を{超えた}。\nThis year's sales exceeded 100 million yen.",
  },
  {
    kanji: "怪しい",
    kana: "あやしい",
  ...
  },
  {
    kanji: "務める",
    kana: "つとめる",
    english: "To serve・to work",
    explanation: "To perform a role or duty, often in a professional or official capacity.",
    example: "彼は市長として10年間{務めた}。\nHe served as mayor for 10 years.",
  },
  {
    kanji: "一流",
    kana: "いちりゅう",
    english: "Top-class・first-rate",
    explanation: "Of the highest quality or standard in a particular field or profession.",
    sameMeaning: "最高っていう意味だ・素晴らしいっていう意味だ",
    example: "彼は{一流}のシェフとして知られている。\nHe is known as a top-class chef.",
    important: true,
  },
  {
    kanji: "詰める",
    kana: "つめる",
    english: "To pack・to stuff",
    explanation: "To fill a space or container tightly with something.",
    example: "新しい家に持って行くものをダンボール箱に{詰める}。\nPack the things to take to the new house into cardboard boxes.",
  },
  {
    kanji: "講演会",
    kana: "こうえんかい",
    english: "Lecture・public talk",
    explanation: "An event where a speaker presents information or ideas to an audience.",
    example: "有名な作家の{講演会}に参加した。\nI attended a lecture by a famous author.",
  },
  {
    kanji: "司会者",
    kana: "しかいしゃ",
    english: "Master of ceremonies・host・moderator",
    explanation: "A person who presides over an event or ceremony, guiding the proceedings.",
    example: "彼は結婚式の{司会者}を務めた。\nHe served as the master of ceremonies at the wedding.",
    important: true,
  },
  {
    kanji: "経済",
    ...
    explanation: "The system of production, distribution, and consumption of goods and services in a society.",
    example: "日本の{経済}は回復しつつある。\nJapan's economy is recovering.",
  },
  {
    kanji: "経済学",
    kana: "けいざいがく",
    english: "Economics",
    explanation: "The study of how societies use resources to produce goods and services and distribute them among individuals.",
    example: "彼は大学で{経済学}を専攻している。\nHe is majoring in economics at university.",
  },
  {
    kanji: "一度でいいから〜てみたい",
    kana: "いちどでいいから〜てみたい",
