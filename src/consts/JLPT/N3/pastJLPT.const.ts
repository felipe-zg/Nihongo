export const PAST_JLPT_N3: JLPTReview[] = [
  ...
  },
  {
    ...
    example: "この携帯電話はボタンが押しにくいという{不満}を持つ利用者もいる。\nSome users have dissatisfaction that the buttons on this mobile phone are hard to press."
  },
  {
    kanji: "ぶらぶら",
    kana: "ぶらぶら",
  ...
  },
  {
    ...
    example: "全員が自分の意見を{主張}したので、会議がなかなか終わらなかった。\nEveryone asserted their own opinions, so the meeting didn't end easily."
  },
  {
    kanji: "命令",
    kana: "めいれい",
    ...
    example: "上司の{命令}に従わなければならない。\nYou must obey your boss's orders."
  },
  {
    kanji: "からから",
    kana: "からから",
  ...
  },
  {
    ...
    example: "小川さんは正直な人で、決してうそは言いません。\nMr. Ogawa is an honest person and never tells lies."
  },
  {
    kanji: "指示",
    kana: "しじ",
    ...
    example: "この書類、30部コピーしておいて」と秘書に指示した。\nI instructed my secretary, 'Please make 30 copies of this document.'"
  },
  {
    kanji: "見送る",
    kana: "みおくる",
